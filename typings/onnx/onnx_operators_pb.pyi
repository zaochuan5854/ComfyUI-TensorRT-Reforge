# ---------------------------------------------------------------------
# ONNX Operators ML Protocol Buffer Type Stub (Full Specification)
...
class OperatorSetProto(_message.Message):
    ...
    # オペレーターのリスト（RepeatedCompositeFieldContainer）
    operator: _containers.RepeatedCompositeFieldContainer[OperatorProto]
    # 関数のリスト（onnx_ml_pb2.FunctionProto を参照）
